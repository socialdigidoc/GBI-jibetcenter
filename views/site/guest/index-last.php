            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    <!-- <div class="categories__text" style="margin-bottom: 200px;"> -->
                        ...
                        <a target="_blank" href="<?= Url::to(['site/shop'])?>">Standing at the centre of dermatology</a>
                        </br>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="services__item">
                    ...
                    <h6>QUALITY</h6>
                    <p>Endless research and development for product quality</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="services__item">
                    ...
                    <h6>INGREDIENTS</h6>
                    <p>Natural ingredients and top of R&D innovation</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="services__item">
                    ...
                    <h6>MAINTAIN</h6>
                    <p>Maintain the essence and be honest</p>
                </div>
            </div>
        </div>
    </div>
