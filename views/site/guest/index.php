                    ...
                    <div class="row align-items-end">
                        ...
                        <div class=" banner-right col-md-6">
                            <figure class="banner-img">
                                ...
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img33.png" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="about-left-content">
                                <figure class="figure-round-border">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img13.jpg" alt="">
                                </figure>
                        ...
                        <div class="col-md-6">
                            <div class=" about-right-content">
                                ...
                                <figure class="figure-round-border">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img12-500px.jpg" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner-course-wrap">
                            <div class="row d-flex justify-content-center justify-content-xl-start">
                                <div class="col-sm-6 col-lg-4 pe-3 ps-3 pt-4 pt-lg-0 inner-course">
                                    <article class="post">
                                        <figure class="feature-image">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img30.jpg" alt="">
                                ...
                                <div class="col-sm-6 col-lg-4 pe-3 ps-3 pt-4 pt-lg-0 inner-course">
                                    <article class="post">
                                        <figure class="feature-image">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img29.jpg" alt="">
                                            <a href="course-detail.html" class="bookmark-icon">
                                                <i aria-hidden="true" class="far fa-bookmark"></i>
                                            </a>
                                            <span class="cat-meta">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="author-content">
                                                <figure class="author-img">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img24.jpg" alt="">
                                                </figure>
                                ...
                                <div class="col-sm-6 col-lg-4 pe-3 ps-3 pt-4 pt-lg-0 inner-course">
                                    <article class="post">
                                        <figure class="feature-image">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img31.jpg" alt="">
                                            <a href="course-detail.html" class="bookmark-icon">
                                                <i aria-hidden="true" class="far fa-bookmark"></i>
                                            </a>
                                            <span class="cat-meta">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="author-content">
                                                <figure class="author-img">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img25.jpg" alt="">
                                                </figure>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3 p-4">
                                <figure class="team-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img8.png" alt="">
                                </figure>
                            ...
                            <div class="col-sm-6 col-lg-3 p-4">
                                <figure class="team-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img11.png" alt="">
                                </figure>
                                <div class="team-content text-center">
                                    <h4>
                            ...
                            <div class="col-sm-6 col-lg-3 p-4">
                                <figure class="team-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img9.png" alt="">
                                </figure>
                                <div class="team-content text-center">
                                    <h4>
                            ...
                            <div class="col-sm-6 col-lg-3 p-4">
                                <figure class="team-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img10.png" alt="">
                                </figure>
                                <div class="team-content text-center">
                                    <h4>
                        ...
                        <div class="col-md-6">
                            <div class="client-content left-content">
                                ...
                                <div class="author-content">
                                    ...
                                    <figure class="author-img">
                                        <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img22.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="client-content right-content">
                                ...
                                <div class="author-content">
                                    ...
                                    <figure class="author-img">
                                        <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img21.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="overlay-wrapper">
                        ...
                        <div class="inner-blog-wrap">
                            <article class="post">
                                <figure class="feature-image">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img12.jpg" alt="">
                                    <span class="cat-meta">
                            ...
                            <article class="post">
                                <figure class="feature-image">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img14.jpg" alt="">
                                    <span class="cat-meta">
                            ...
                            <article class="post item-3">
                                <figure class="feature-image">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest//img/educator-img13.jpg" alt="">
                                    <span class="cat-meta">
                                        <a href="blog-archive.html">EDUCATION</a>
                                    </span>
                                </figure>
                ...
                <div class="container">
                    <div class="client-slider text-center">
                        <div class="client-item">
                            <figure>
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img16.png" alt="">
                            </figure>
                        </div>
                        <div class="client-item">
                            <figure>
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img17.png" alt="">
                            </figure>
                        </div>
                        <div class="client-item">
                            <figure>
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img18.png" alt="">
                            </figure>
                        </div>
                        <div class="client-item">
                            <figure>
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img19.png" alt="">
                            </figure>
                        </div>
                        <div class="client-item">
                            <figure>
                                <img src="<?= Yii::$app->request->baseUrl ?>/web/assets-guest/assets/img/educator-img20.png" alt="">
                            </figure>
                        </div>
                        <div class="client-item">
                            <figure>
