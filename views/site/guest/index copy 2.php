    ...
    <section id="hero" class="hero-1">
        <div class="slideshow-container">
            <div class="mySlides fadedigi">
                <img src="<?= Yii::$app->request->baseUrl ?>/web/img/mainslider/images-1.jpg" class="styleimages">
            </div>
            <div class="mySlides fadedigi">
                <img src="<?= Yii::$app->request->baseUrl ?>/web/img/mainslider/images-2.jpg" class="styleimages">
            </div>
            <div class="mySlides fadedigi">
