                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Kategori 1</a>
                                        </div>
                                        <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                    <li><a href="#">Sub Kategori 1a</a></li>
                                                    <li><a href="#">Sub Kategori 1b</a></li>
                                                    <li><a href="#">Sub Kategori 1c</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseTwo">Kategori 2</a>
                                        </div>
                                        <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                            <div class="card-body">
                                            <ul>
                                                    <li><a href="#">Sub Kategori 2a</a></li>
                                                    <li><a href="#">Sub Kategori 2b</a></li>
                                                    <li><a href="#">Sub Kategori 2c</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseThree">Kategori 3</a>
                                        </div>
                                        <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                    <li><a href="#">Sub Kategori 3a</a></li>
                                                    <li><a href="#">Sub Kategori 3b</a></li>
                                                    <li><a href="#">Sub Kategori 3c</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseFour">Kategori 4</a>
                                        </div>
                                        <div id="collapseFour" class="collapse" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                    <li><a href="#">Sub Kategori 4a</a></li>
                                                    <li><a href="#">Sub Kategori 4b</a></li>
                                                    <li><a href="#">Sub Kategori 4c</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseFive">Kategori 5</a>
                                        </div>
                                        <div id="collapseFive" class="collapse" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                    <li><a href="#">Sub Kategori 5a</a></li>
                                                    <li><a href="#">Sub Kategori 5b</a></li>
                                                    <li><a href="#">Sub Kategori 5c</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 1</a></h6>
                                    <div class="rating">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 2</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 3</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 4</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item sale">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 5</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 6</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 7</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 8</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item sale">
                                <div class="product__item__pic set-bg" data-setbg="<?= Yii::$app->request->baseUrl ?>/web/img/produk/produk-9.png">
                                    <div class="label">Sale</div>
                                    <ul class="product__hover">
                                        <li><a href="<?= Yii::$app->request->baseUrl ?>/web/img/produk/produk-9.png" class="image-popup"><span class="arrow_expand"></span></a></li>
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="<?= Url::to(['site/shop-detail'])?>">Iorem Ipsum 9</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
